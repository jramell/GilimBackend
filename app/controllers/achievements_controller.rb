class AchievementsController < ApplicationController
  ...
  private
    ...
    def set_list_achievement
      if (params[:event_id])
        evento = find_event(params[:event_id])
        @achievements = evento.achievements
      else
        @achievements = Achievement.all
      end
    end
    ...
    def achievement_params
      params.require(:achievement).permit(:event_id, :name, :points, :description)
    end
end
