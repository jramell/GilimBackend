...
class AchievementsControllerTest < ActionController::TestCase
  ...
  test "should create achievement" do
    assert_difference('Achievement.count') do
      post :create, achievement: { description: @achievement.description, event_id: @achievement.event_id, name: @achievement.name, points: @achievement.points }
    end
  ...
  test "should update achievement" do
    patch :update, id: @achievement, achievement: { description: @achievement.description, event_id: @achievement.event_id, name: @achievement.name, points: @achievement.points }
    assert_redirected_to achievement_path(assigns(:achievement))
  end
